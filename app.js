...
document.querySelector('.x-btn').addEventListener('click', () => {
  ...
  document.querySelector('.container').style.cssText = 'background: linear-graident(rgba(0, 0, 0, .8), rgba(0,0,0, .7)), url(public/image/bg1.jpg) center no-repeat; background-size: cover';
})
